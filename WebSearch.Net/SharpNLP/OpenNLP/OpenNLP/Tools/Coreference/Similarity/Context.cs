...
namespace OpenNLP.Tools.Coreference.Similarity
{
    ...
    public class Context : Mention.Mention
    {
        ...
        public Context(Util.Span span, Util.Span headSpan, int entityId, 
            Mention.IParse parse, string extentType, string nameType, Mention.IHeadFinder headFinder)
        ...
        public Context(Mention.Mention mention, Mention.IHeadFinder headFinder)
            : base(mention)
        {
            Initialize(headFinder);
        }
