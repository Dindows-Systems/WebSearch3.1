...
namespace SharpWordNet
{
    ...
    public class DataFileEngine : WordNetEngine
    {
        ...
        private Dictionary<string, PosDataFileSet> _dataFileDictionary;
        ...
        public DataFileEngine(string dataFolder)
        {
            ...
            _dataFileDictionary.Add("noun", new PosDataFileSet(dataFolder, "noun"));
            _dataFileDictionary.Add("verb", new PosDataFileSet(dataFolder, "verb"));
            _dataFileDictionary.Add("adjective", new PosDataFileSet(dataFolder, "adj"));
            _dataFileDictionary.Add("adverb", new PosDataFileSet(dataFolder, "adv"));
        ...
        protected internal override Synset CreateSynset(string partOfSpeech, int synsetOffset)
        {
            ...
            string lexicographerFile = _lexicographerFiles[int.Parse(tokenizer.NextToken())];
        ...
        private void InitializeRelationTypes()
        {
            ...
            _relationTypeDictionary.Add("!", new RelationType("Antonym", new string[] { "noun", "verb", "adjective", "adverb" }));
            _relationTypeDictionary.Add("@", new RelationType("Hypernym", new string[] { "noun", "verb" }));
            _relationTypeDictionary.Add("@i", new RelationType("Instance Hypernym", new string[] { "noun" }));
            _relationTypeDictionary.Add("~", new RelationType("Hyponym", new string[] { "noun", "verb" }));
            _relationTypeDictionary.Add("~i", new RelationType("Instance Hyponym", new string[] { "noun" }));
            _relationTypeDictionary.Add("#m", new RelationType("Member holonym", new string[] { "noun" }));
            _relationTypeDictionary.Add("#s", new RelationType("Substance holonym", new string[] { "noun" }));
            _relationTypeDictionary.Add("#p", new RelationType("Part holonym", new string[] { "noun" }));
            _relationTypeDictionary.Add("%m", new RelationType("Member meronym", new string[] { "noun" }));
            _relationTypeDictionary.Add("%s", new RelationType("Substance meronym", new string[] { "noun" }));
            _relationTypeDictionary.Add("%p", new RelationType("Part meronym", new string[] { "noun" }));
            _relationTypeDictionary.Add("=", new RelationType("Attribute", new string[] { "noun", "adjective" }));
            _relationTypeDictionary.Add("+", new RelationType("Derivationally related form", new string[] { "noun", "verb" }));
            _relationTypeDictionary.Add(";c", new RelationType("Domain of synset - TOPIC", new string[] { "noun", "verb", "adjective", "adverb" }));
            _relationTypeDictionary.Add("-c", new RelationType("Member of this domain - TOPIC", new string[] { "noun" }));
            _relationTypeDictionary.Add(";r", new RelationType("Domain of synset - REGION", new string[] { "noun", "verb", "adjective", "adverb" }));
            _relationTypeDictionary.Add("-r", new RelationType("Member of this domain - REGION", new string[] { "noun" }));
            _relationTypeDictionary.Add(";u", new RelationType("Domain of synset - USAGE", new string[] { "noun", "verb", "adjective", "adverb" }));
            _relationTypeDictionary.Add("-u", new RelationType("Member of this domain - USAGE", new string[] { "noun" }));

            _relationTypeDictionary.Add("*", new RelationType("Entailment", new string[] { "verb" }));
            _relationTypeDictionary.Add(">", new RelationType("Cause", new string[] { "verb" }));
            _relationTypeDictionary.Add("^", new RelationType("Also see", new string[] { "verb", "adjective" }));
            _relationTypeDictionary.Add("$", new RelationType("Verb Group", new string[] { "verb" }));

            _relationTypeDictionary.Add("&", new RelationType("Similar to", new string[] { "adjective" }));
            _relationTypeDictionary.Add("<", new RelationType("Participle of verb", new string[] { "adjective" }));
            _relationTypeDictionary.Add(@"\", new RelationType("Pertainym", new string[] { "adjective", "adverb" }));
