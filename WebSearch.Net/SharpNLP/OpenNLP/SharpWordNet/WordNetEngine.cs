...
namespace SharpWordNet
{
    ...
    public abstract class WordNetEngine
    {
        ...
        public delegate void MorphologicalProcessOperation(string lemma,
            string partOfSpeech, List<string> baseForms);
        ...
        public string[] GetBaseForms(string lemma, string partOfSpeech)
        {
            if (mDefaultOperations == null)
            {
                ...
                tokDso.AddDelegate(Morph.DetachSuffixesOperation.Operations,
                    new Morph.IOperation[] { new Morph.LookupIndexWordOperation(this),
                        new Morph.LookupExceptionsOperation(this) });
                Morph.TokenizerOperation tokOp = new Morph.TokenizerOperation(this,
                    new string[] { " ", "-" });
                tokOp.AddDelegate(Morph.TokenizerOperation.TokenOperations,
                    new Morph.IOperation[] { new Morph.LookupIndexWordOperation(this),
                        new Morph.LookupExceptionsOperation(this), tokDso });
                ...
                morphDso.AddDelegate(Morph.DetachSuffixesOperation.Operations, new Morph.IOperation[] {
                    new Morph.LookupIndexWordOperation(this),
                    new Morph.LookupExceptionsOperation(this) });
                mDefaultOperations = new Morph.IOperation[] { 
                    new Morph.LookupExceptionsOperation(this), morphDso, tokOp };
            }
