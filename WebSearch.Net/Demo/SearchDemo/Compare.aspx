                ...
                <asp:Panel DefaultButton="btn_Search" runat="server" ID="panel_Head">
                    <table width="840" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="100">
                                <span class="nhwhite13">日志：</span><asp:TextBox runat="server" ID="tb_QueryLog" Text="Sogou"
                            ...
                            <td width="70">
                                <span style="padding-top: 7px"><a href="Default.aspx" class="nhwhite12">搜索主页</a></span></td>
                        </tr>
                    </table>
                </asp:Panel>
            </div>
                ...
                <asp:Panel DefaultButton="btn_Search2" runat="server" ID="panel_Foot">
                    <table width="840" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="100">
                                <span class="nhwhite13">日志：</span><asp:TextBox runat="server" ID="tb_QueryLog2" Text="Sogou"
                                    Width="40"></asp:TextBox></td>
                            <td width="310" align="center">
