...
public partial class ChartingIQ : System.Web.UI.Page
{
    ...
    private void DrawWebChart(string datasetName)
    {
        ...
        QuerySurveyCollection collection = new QuerySurveyCollection(datasetName);
        ...
        informational.DataSource = collection.GetQueryTypeDistribution
            (QueryType.Informational, 0.5F).DefaultView;
        ...
        // get the data view to be shown on the chart
        navigational.DataSource = collection.GetQueryTypeDistribution
            (QueryType.Navigatinoal, 0.5F).DefaultView;
        ...
        // get the data view to be shown on the chart
        transactional.DataSource = collection.GetQueryTypeDistribution
            (QueryType.Transactional, 0.5F).DefaultView;
